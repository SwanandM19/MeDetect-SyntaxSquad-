            ...
            {affectedAreas && affectedAreas.map((area, i) => {
                ...
                return (
                    <Html
                        ...
                        center
                    >
                        <div className={`px-3 py-1 rounded-md text-xs font-semibold pointer-events-none shadow-lg text-white ${area.severity === 'Severe' ? 'bg-red-600' :
                                ...
                                {selectedArea && (
                                    <div className="absolute bottom-4 left-4 bg-white p-4 rounded-lg shadow-xl max-w-sm border-l-4 border-red-500 z-10">
                                        ...
                                        <div className="mt-3 flex justify-between items-center">
                                            <span className={`px-3 py-1 rounded-full text-xs font-semibold ${selectedArea.severity === 'Severe' ? 'bg-red-200 text-red-800' :
                                ...
                                <div className="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-500">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            ...
                                            <span className={`font-semibold ml-2 ${reportData.assessment.urgency === 'Urgent' ? 'text-red-600' :
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                            ...
                            <div className="space-y-4">
                                {reportData.physicalFindings.affectedAreas.map((area, i) => (
                                    <div
                                        key={i}
                                        className={`border-l-4 p-4 rounded-r-lg cursor-pointer transition-all duration-200 hover:shadow-md ${area.severity === 'Severe' ? 'border-red-600 bg-red-50' :
                                    ...
                                    >
                                        <div className="flex justify-between items-start mb-3">
                                            <h3 className={`font-semibold ${area.severity === 'Severe' ? 'text-red-800' :
                                                    area.severity === 'Moderate' ? 'text-orange-800' :
                                                        'text-yellow-800'
                                                }`}>
                                                {area.name}
                                            </h3>
                                            <span className={`px-2 py-1 rounded-full text-xs font-semibold ${area.severity === 'Severe' ? 'bg-red-200 text-red-800' :
                                        ...
                                        <div className="flex flex-wrap gap-1">
                                            {area.symptoms.map((symptom, j) => (
                                                <span key={j} className={`px-2 py-1 text-xs rounded-full ${area.severity === 'Severe' ? 'bg-red-100 text-red-700' :
                                    ...
                                    {reportData.recommendations.map((rec, i) => (
                                        <div key={i} className={`p-3 rounded-lg border-l-4 ${getPriorityColor(rec.priority)}`}>
                                            <div className="flex justify-between items-center mb-2">
                                                <span className={`text-xs font-semibold uppercase px-2 py-1 rounded ${rec.type === 'avoidance' ? 'bg-red-100 text-red-600' :
                                                ...
                                                <span className={`text-xs font-semibold ${rec.priority === 'Critical' ? 'text-red-600' :
